...
export const navItems: NavItem[] = [
  { label: 'Como funciona', href: '/#como-funciona', group: 'primary', order: 0 },
  { label: 'Recursos', href: '/#entregas', group: 'primary', order: 1 },
  { label: 'Áreas de atuação', href: '/#areas', group: 'primary', order: 2 },
  { label: 'Conformidade', href: '/#conformidade', group: 'primary', order: 3 },
  { label: 'Perguntas frequentes', href: '/#faq', group: 'primary', order: 4 },
  {
    label: 'Falar com a equipe',
    href: 'mailto:tervox@polsia.app',
    group: 'secondary',
    order: 0,
  },
];
